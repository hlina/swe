    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <li><a class="navbar-brand" href="#page-top">Penn SWE</a></li>
                </ul>
            </div>
...
<!--                 <div id="login">
                ...
                <?
                    ...
                    <p><i>You have logged out of <b><? echo $_SESSION['user']['email'] ?></b></i></p>
                <?
                        session_destroy();
                ?>
                <script type="text/javascript">
                setTimeout("window.location = '<?php echo "https://weblogin.pennkey.upenn.edu/logout" ?>'", 0);
                </script>
                </head>
                <?
                    }
                ...
                ?>
                    <p><i>You are signed in as <b><? echo $_SESSION['user']['email'] ?></b></i></p>
                    <form name="logout-form" class="form" method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
                        <a href="members.php" class="join">Member Page</a> <input class="join" name="logout" value="Sign Out" type="submit"> 
                    </form>
                <?
                    }
                    ...
                    <META HTTP-EQUIV="Refresh" Content="0; URL=https://fling.seas.upenn.edu/~swe/cgi-bin/member/member.php">
                    <?
                    }
                    else {
                    ?>
                    <p>Login with your SEAS email:</p>
                    <form name="login-form" class="form" method="post" onsubmit="return validateLogin();" action="<?php echo $_SERVER['PHP_SELF'];?>">
                        <input class="signin" type="email" name="email" placeholder="SEAS email">
                        <input class="join" name="login" value="GO!" type="submit">
                    </form>
                    <?
                    } 
                    ?>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="intro-text">
                        <span class="name">Penn Society of Women Engineers</span>
                        <hr class="star-light">
    ...
    <footer class="text-center">
            ...
            <div class="container">
                <div class="row">
                    <div class="footer-col col-md-4">
                        <h3>ABOUT</h3>
                        <p>Vision</p>Programming<br>Gallery</p>
                    </div>
                    <div class="footer-col col-md-4">
                    ...
                    <div class="footer-col col-md-4">
                        <h3>GET INVOLVED</h3>
                        <p>Sponsorship<br>Subscribe<br>Board Contacts</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="footer-below">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        Copyright &copy; PennSWE Lina Huang 2015
                    </div>
                </div>
            </div>
        </div>
